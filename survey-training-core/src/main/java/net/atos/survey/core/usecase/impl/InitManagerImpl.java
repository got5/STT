...
public class InitManagerImpl implements InitManager {
	...
	public void initDB() {
		...
		//question
		SimpleMCQuestion mcq1 = new SimpleMCQuestion(MCQ1, true, null, false);
		mcq1.addChoice(ch1);
		mcq1.addChoice(ch2);
		mcq1.addChoice(ch3);
		mcq1.addChoice(ch4);
	...
	public void testOneSurvey() throws Exception {
		...
		Theme t2 = new Theme("Exercices et TP");
		Theme t3 = new Theme("Documentation");
		Theme t4 = new Theme("Formateur");
		Theme t5 = new Theme("Divers");
		Theme t6 = new Theme("Le stage dans son ensemble");
		...
		//TRAINING
		Training tapestryBasic = trainingManager.createTraining("Tapestry Basic", TypeTraining.LECTURE_AND_TP, responsable.getId());
		...
		Calendar now= new GregorianCalendar(2012, 10, 21, 9, 0);
		Calendar afterNow = new GregorianCalendar(2012, 10, 23, 18, 0);
		System.out.println("now "+now.getTimeInMillis() +" afterNow "+afterNow.getTimeInMillis());
		System.out.println("training "+tapestryBasic.getId()+" room "+room.getId());
		System.out.println("trainingManagerDao ");
		System.out.println(trainingSessionManager==null);
